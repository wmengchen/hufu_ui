...
sheetName = 'guideCreateTable_dim'
...
@ddt.ddt
class guideCreateTable_dim(unittest.TestCase):
    ...
    @ddt.data(*testData)
    def test_guideCreateTable_dim(self, data):
        ...
        Element(self.driver, 'dataStanard', 'dim_chooseclick').wait_click()
        ...
        if value == 'correct':
            ...
            Element(self.driver, 'dataStanard', 'para1desc_intputclick').wait_click()
            time.sleep(1)
            Element(self.driver, 'dataStanard', 'dim_major_key_click').wait_click()
            Element(self.driver, 'dataStanard', 'dim_para1_saveclick').wait_click()
            time.sleep(1)
            Element(self.driver, 'dataStanard', 'addpar_click').wait_click()
            ...
            Element(self.driver, 'dataStanard', 'dim_para2_saveclick').wait_click()
            time.sleep(1)
            Element(self.driver, 'dataStanard', 'dim_para2_deleteclick').wait_click()
            time.sleep(1)
            Element(self.driver, 'dataStanard', 'addpar_click').wait_click()
            Element(self.driver, 'dataStanard', 'paraname2_click').wait_click()
            Element(self.driver, 'dataStanard', 'paraname2_inputclick').wait_send_keys(data["para2name"])
            ...
            Element(self.driver, 'dataStanard', 'dim_para2_saveclick').wait_click()
            time.sleep(1)
            Element(self.driver, 'dataStanard', 'dim_para2_editclick').wait_click()
            Element(self.driver, 'dataStanard', 'dim_para2_editsaveclick').wait_click()
            time.sleep(1)
            Element(self.driver, 'dataStanard', 'addpar_click').wait_click()
            ...
            Element(self.driver, 'dataStanard', 'paraname3_dimsave').wait_click()
            # time.sleep(1)
