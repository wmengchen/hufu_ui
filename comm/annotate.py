...
parser.add_argument('-i', '--input_dir', default='baseline_image', type=str, help='Path to input directory')
parser.add_argument('-o', '--output_dir', default='masks', type=str, help='Path to output directory')
...
if TRACKER_TYPE == "DASIAMRPN":
    print("DASIAMRPN Tracker not supported")
...
annotation_formats = {'yolo_labels' : '.txt'}
...
def draw_bboxes_from_file(tmp_img, annotation_paths, width, height):
    ...
    ann_path = next(path for path in annotation_paths if 'yolo_labels' in path)
